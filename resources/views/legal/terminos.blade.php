...
<x-slot name="header">
    ...
    <main class="content">
        <div class="terms-container">
            ...
            <p class="intro">Última actualización: 1/09/2024</p>

            <h2>Información general</h2>
                <p>Este sitio web es operado por Yummy con nombre comercial YUMMY S.A. de C.V. En todo el sitio, los términos “nosotros”, “nos” y “nuestro” se refieren a Yummy con nombre comercial YUMMY S.A. de C.V ofrece este sitio web, incluyendo toda la información, herramientas y servicios disponibles para ti en este sitio, el usuario, está condicionado a la aceptación de todos los términos, condiciones, políticas y notificaciones aquí establecidos.</p>
            ...
            <p>
                Los precios de nuestros productos están sujetos a cambio sin aviso.            </p>
            <p>
            ...
            <p>
            Ciertos productos o servicios pueden estar disponibles exclusivamente en línea a través del sitio web. Estos productos o servicios pueden tener cantidades limitadas y estar sujetas a devolución o cambio de acuerdo a nuestra política de devolución solamente.            </p>
            <p>
            Hemos hecho el esfuerzo de mostrar los colores y las imágenes de nuestros productos, en la tienda, con la mayor precisión de colores posible. No podemos garantizar que el monitor de tu computadora muestre los colores de manera exacta.            </p>
            <p>
            Todos los productos son sujetos a disponibilidad. Las imágenes de los banners son ilustrativas. Estos legales cubren todas las publicaciones hechas en todos los medios.            </p>
            <p>
            Todas las promociones no son acumulable con otras promociones. Aplican hasta agotar existencias y están restringidas a una por persona.            </p>
            <p>
            El uso de cupones es personal, solo un cupón por usuario. Cupón por orden. Cada cupón puede tener restricciones particulares que serán comunicadas en el banner.            </p>
            <p>
            ...
            <p>
            Precios pueden variar sin previo aviso debido a factores externos: devaluaciones monetarias, alteraciones drásticas en el tipo de cambio, entre otras.            </p>
            <p>
            ...
            <p>
            Es posible que te proporcionamos acceso a herramientas de terceros a los cuales no monitoreamos y sobre los que no tenemos control ni entrada.            </p>
            <p>
            ...
            <p>
            Cualquier uso que hagas de las herramientas opcionales que se ofrecen a través del sitio bajo tu propio riesgo y discreción y debes asegurarte de estar familiarizado y aprobar los términos bajo los cuales estas herramientas son proporcionadas por el o los proveedores de terceros.                </p>
            <p>
            ...
            <p>
            Nosotros podemos, pero no tenemos obligación de, monitorear, editar o remover contenido que consideremos sea ilegítimo, ofensivo, amenazante, calumnioso, difamatorio, pornográfico, obsceno u objetable o viole la propiedad intelectual de cualquiera de las partes o los Términos de Servicio.            </p>
            <p>
            ...
            <p>
            Tu presentación de información personal a través del sitio se rige por nuestra Política de Privacidad. Visita nuestro Aviso de Privacidad.            </p>
            ...
            <p>
            En adición a otras prohibiciones como se establece en los Términos de Servicio, se prohíbe el uso del sitio o su contenido:            </p>
            <ul>
                <li>(a) para ningún propósito ilegal</li>
                <li>(b) para pedirle a otros que realicen o participen en actos ilícitos</li>
                <li>(c) para violar cualquier regulación, reglas, leyes internacionales, federales, provinciales o estatales, u ordenanzas locales</li>
                <li>(d) para infringir o violar el derecho de propiedad intelectual nuestro o de terceras partes</li>
                <li>(e) para acosar, abusar, insultar, dañar, difamar, calumniar, desprestigiar, intimidar o discriminar por razones de género, orientación sexual, religión, etnia, raza, edad, nacionalidad o discapacidad</li>
                <li>(f) para presentar información falsa o engañosa</li>
                <li>(g) para cargar o transmitir virus o cualquier otro tipo de código malicioso que sea o pueda ser utilizado en cualquier forma que pueda comprometer la funcionalidad o el funcionamiento del Servicio o de cualquier sitio web relacionado, otros sitios o Internet</li>
                <li>(h) para recopilar o rastrear información personal de otros</li>
                <li>(i) para generar spam, phish, pharm, pretext, spider, crawl, or scrape</li>
                <li>(j) para cualquier propósito obsceno o inmoral; o</li>
                <li>para interferir con o burlar los elementos de seguridad del Servicio o cualquier sitio web relacionado con otros sitios o Internet.</li>
            </ul>
            ...
            <p>
            No garantizamos ni aseguramos que el uso de nuestro servicio será ininterrumpido, puntual, seguro o libre de errores.            </p>
            <p>
            No garantizamos que los resultados que se puedan obtener del uso del servicio serán exactos o confiables.            </p>
            <p>
            Aceptas que de vez en cuando podemos quitar el servicio por períodos de tiempo indefinidos o cancelar el servicio en cualquier momento sin previo aviso.            </p>
            <p>
            ...
            <p>
            Estas Condiciones de servicio son efectivos a menos que y hasta que sea terminado por ti o nosotros. Puedes terminar estos Términos de Servicio en cualquier momento por avisarnos que ya no deseas utilizar nuestros servicios, o cuando dejes de usar nuestro sitio.            </p>
            <p>
            Si a nuestro juicio, fallas, o se sospecha que usted ha fallado, en el cumplimiento de cualquier término o disposición de estas Condiciones de Servicio, también podemos terminar este acuerdo en cualquier momento sin previo aviso, y seguirás siendo responsable de todos los montos adeudados hasta incluida la fecha de terminación; y/o en consecuencia podemos negar el acceso a nuestros servicios (o cualquier parte del mismo).            </p>
            ...
            <p>
            Condiciones <br>
Para ser elegible para una devolución, el artículo debe: <br>
- Estar sin usar y en las mismas condiciones en que lo recibiste. También debe estar en su embalaje original. <br> - Existen varios tipos de bienes que están exentos de ser devueltos. Productos perecederos tales como alimentos, flores, periódicos o revistas no pueden ser devueltos. Tampoco aceptamos productos que son bienes íntimos o sanitarios, materiales peligrosos, o líquidos o gases inflamables.
            </p>
            <p>
            Hay algunas situaciones donde solo se pueden garantizar reembolsos parciales: <br>
- Cualquier producto que no se encuentre en su condición original, esté dañado o le falten partes por razones ajenas a nosotros. - Productos que muestren signos evidentes de uso, especialmente aquellos que no sean perecederos.
            </p>
            <p>
            Si deseas hacer la devolución de alguno de nuestros productos, lo puedes hacer de las siguientes maneras: <br>
- En nuestra plataforma, dentro de la sección \"Mi pedido\", el cliente puede solicitar una devolución o reportar un problema directamente en la aplicación. <br> - Solicitar la devolución dentro del plazo de devolución por correo electrónico: devoluciones@yummy.com - Atención telefónica al: +52 919 166 0416
            </p>  

            <!-- sección 19 -->    
            <h2>Sección 19 – Ley</h2>
            <p>
            Para la interpretación y cumplimiento de los presentes términos y condiciones, las partes se someten a la jurisdicción de los tribunales de la Ciudad de renunciado expresamente a cualquier otro fuero que pudiere corresponderles por razón de sus domicilios presentes o futuros.            </p>
            ...
            <p>
            Preguntas acerca de los Términos de Servicio deben ser enviadas a teamsoudev@gmail.com.            </p>
